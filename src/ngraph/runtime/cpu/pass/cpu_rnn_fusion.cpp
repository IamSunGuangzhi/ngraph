...
void ngraph::runtime::cpu::pass::LSTMFusion::construct_lstm_fprop()
{
    ...
    auto callback = [ct_label, w_i2h, bias_i2h, w_h2h, bias_h2h, xt, ht_1, ct_1](
        ...
        // if (!(is_type<ngraph::op::Broadcast>(cell_state.get_node()) &&
        //       is_type<ngraph::op::Constant>(cell_state.get_node()->input_value(0).get_node())) &&
        //     !(is_type<ngraph::op::GetOutputElement>(cell_state.get_node())))
        // {
        //     return false;
        // }
